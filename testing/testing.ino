...
const uint8_t ARDUINO_RX = 3; // connect to TX of MP3 Player module
const uint8_t ARDUINO_TX = 2; // connect to RX of MP3 Player module
...
// or called locally when not in callback mode.
{
    ...
    case MD_YX5300::STS_FLDR_FILES:
        Console.print(F("STS_FLDR_FILES"));
        break;
    case MD_YX5300::STS_TOT_FLDR:
        Console.print(F("STS_TOT_FLDR"));
        break;
    default:
        Console.print(F("STS_??? 0x"));
